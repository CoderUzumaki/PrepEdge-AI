  ...
  return (
    <div>
      <motion.section
        ...
        className="relative bg-gradient-to-br from-blue-500 via-green-500 to-emerald-600 overflow-hidden min-h-[600px]"
      >
            ...
            <div className="text-stone-50 order-2 lg:order-1">
              <div className="max-w-lg">
                <motion.h1
                  ...
                  className="text-4xl lg:text-5xl font-bold mb-6 leading-tight text-stone-50"
                >
                  Ace Your Interviews with
                  <span className="block text-white">Expert Resources</span>
                </motion.h1>
                <motion.p
                  initial="hidden"
                  whileInView="visible"
                  ...
                  className="text-xl text-stone-50 opacity-90 mb-8 leading-relaxed"
                >
                ...
                <div className="flex items-center space-x-6 mb-8">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-stone-50">50+</div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-stone-50">95%</div>
                    <div className="text-sm text-stone-50 opacity-80">
                      Success Rate
                    </div>
                  </div>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative z-10">
                <motion.div
                  ...
                  className="relative bg-white bg-opacity-10 rounded-3xl p-8 backdrop-blur-sm border border-white border-opacity-20"
                >
                  <motion.img
                    initial="hidden"
                    animate="visible"
      ...
      <motion.section
        ...
        className="relative py-16 bg-gradient-to-br from-gray-200 via-stone-50 to-white"
      >
        <div className="absolute inset-0">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
          <div className="mb-12">
            ...
            >
              Handpicked Resources to get yourself started on your Interview
              prep journey!
            </motion.p>
          </div>
          <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mb-20">
          ...
          >
            {resources.map((resource) => (
              ...
              >
                <ResourceCard {...resource} cardVariant={cardVariant} />
              </motion.div>
            ))}
          </motion.div>
        </div>
